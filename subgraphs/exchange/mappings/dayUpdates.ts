...
export function updateTokenDayData(token: Token, event: ethereum.Event): TokenDayData {
  ...
  if (tokenDayData === null) {
    ...
    tokenDayData.priceUSD = token.derivedKAI.times(bundle.kaiPrice);
    tokenDayData.dailyVolumeToken = ZERO_BD;
    tokenDayData.dailyVolumeKAI = ZERO_BD;
  ...
  tokenDayData.totalLiquidityKAI = token.totalLiquidity.times(token.derivedKAI as BigDecimal);
  tokenDayData.totalLiquidityUSD = tokenDayData.totalLiquidityKAI.times(bundle.kaiPrice);
